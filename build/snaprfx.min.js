...
c.filter_specs={_original:{name:"*Original*",slug:"_original",layers:[]}};c.stickers=[];c.text=[]};SnaprFX.prototype.set_url=function(b,c){var a=this;this.options.url=b;var d=new Deferred;SnaprFX.utils.read_exif(a.options.url).done(function(c){a.exif=c;a.load_original(!0).done(function(){a.apply_filter({editable:a.render_options.editable});d.resolve()})});return d};
